...
export default function NewProjectPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(`${formData.title} added to project archive`);
    ...
    <div className="mx-auto max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-serif text-3xl font-medium text-foreground tracking-tight">New Project</h1>
            <p className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-bold">Documenting a new design collaboration in the Santiago Bros archive.</p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  placeholder="e.g. Marbella Villa Renovation"
                />
              </div>
              <div className="space-y-2">
                ...
                <input 
                  ...
                  placeholder="marbella-villa-renovation"
                />
              </div>
              <div className="space-y-2">

    ...
    >
      <nav className="container mx-auto px-4 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <Link href="/showroom" className={buttonVariants({ variant: "default" })}>
            Book Appointment
          </Link>
          <Avatar className="h-9 w-9 border border-border">
            <AvatarImage src="" />
            <AvatarFallback className="bg-secondary text-secondary-foreground font-serif text-xs">SB</AvatarFallback>
          </Avatar>
        </div>

        {/* Mobile Hamburger */}
        <button
          className="lg:hidden z-[51] p-2 text-foreground"
